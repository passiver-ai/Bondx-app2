            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[#6B7280] pretendard-500 text-[14px]">BONDX</p>
                </div>
              </div>
              <div className="text-right">
                <div className="inter-600 text-[18px] text-black">2,000.392839</div>
                <div className="text-[#6B7280] pretendard-500 text-[14px]">≈ 0 USDT</div>
              </div>
            </div>
