...
export default function Home() {
  ...
  return (
    <form
      ...
      <div className="text-[24px] inter-600 text-black">Forgot your password?</div>
      ...
      <div className="w-full">
        <ActionButton title={'Send Verification E-mail'} type={'submit'} isDisabled={!isDirty || !isValid} />
      </div>
    </form>
  );
}
